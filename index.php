...
<html lang="en">
  ...
  <body class=" ">
    ...
    <button id="theme-toggle" class="toggle-button">Light Theme</button>
      <header class="logo">
      ...
      <main>
        ...
        <div class="main">
          <div id="todo" class="todo drag">
            <h2 class="card-heading">To Do</h2>
          </div>
          <div id="progress" class=" drag">
            <h2 class="card-heading">Process</h2>
          </div>
          <div id="completed" class="completed drag">
